...
function list_box ($tblname, $name='lb', $currentval='', $submit='', $fvalue='', $fdisplay='', $where='', $order='') {
	global $style;
	...
	$kq = mysql_query ("select {$fvalue}, {$fdisplay} from $tblname{$where}{$order}") or die ("Lỗi truy xuất bảng $tblname trong list_box");
